...
def abrir_ventana_accion(titulo):
    ...
    boton_regresar=ctk.CTkButton(nueva_ventana,text="Volver al menú",command=nueva_ventana.destroy)
    boton_regresar.pack
...
def mostrar_pantalla_admin(ventana):
    ...
    boton_modificarU=ctk.CTkButton(frame_menu,text="Modificar usuarios",width=220,height=50,command=lambda:abrir_ventana_accion("Modificar Usuarios"))
    boton_modificarU.grid(row=0,column=1,padx=10,pady=10)
    
    boton_listaU=ctk.CTkButton(frame_menu,text="Lista de usuarios",width=220,height=50,command=lambda:abrir_ventana_accion("Lista de Usuarios"))
    boton_listaU.grid(row=1,column=0,padx=10,pady=10)
    
    boton_crearS=ctk.CTkButton(frame_menu,text="Crear Salas",width=220,height=50,command=lambda:abrir_ventana_accion("Crear Salas"))
    boton_crearS.grid(row=1,column=1,padx=10,pady=10)

    boton_ListaS=ctk.CTkButton(frame_menu,text="Lista de Salas",width=220,height=50,command=lambda:abrir_ventana_accion("Lista de Salas"))
    boton_ListaS.grid(row=2,column=0,padx=10,pady=10)

    boton_crearP=ctk.CTkButton(frame_menu,text="Crear Producto",width=220,height=50,command=lambda:abrir_ventana_accion("Crear Productp"))
    boton_crearP.grid(row=2,column=1,padx=10,pady=10)

    boton_ListaP=ctk.CTkButton(frame_menu,text="Lista de Productos",width=220,height=50,command=lambda:abrir_ventana_accion("Lista de Productos"))
    boton_ListaP.grid(row=3,column=0,padx=10,pady=10)
...
def mostrar_pantalla_login(ventana):
    ...
    imagen = Image.open("C:/Users/DELL/Desktop/Actividad/cine/logocine.png")
