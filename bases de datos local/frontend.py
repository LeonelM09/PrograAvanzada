    ...
    def iniciar():
        ...
        if usuario_encontrado:
            if usuario_encontrado.contra == password:
                if name == "Leonel":
                    messagebox.showinfo("Login", "Bienvenido, Leonel")
                    ven2.destroy()
                    ventana_miUsuario()
                if name == "Normal":
...
def ventana_miUsuario():
    
    ven4=tk.Tk()
    ven4.title("Mi Usuario")
    ven4.geometry("400x500")

    etiqueta4=tk.Label(ven4,text="Esta es mi ventana")
    etiqueta4.pack(pady=10)

    boton1=tk.Button(ven4,text="Opción 1")
    boton1.pack(pady=10)
    boton2=tk.Button(ven4,text="Opción 2")
    boton2.pack(pady=10)
    boton3=tk.Button(ven4,text="Opción 3")
    boton3.pack(pady=10)
    boton4=tk.Button(ven4,text="Opción 4")
    boton4.pack(pady=10)
...
def ventana_Normal():
    ...
    etiqueta4=tk.Label(ven4,text="Normal")
    etiqueta4.pack(pady=10)
